...
@Component({
  templateUrl: './twenty-one-stats.component.html',
  styleUrls: ['./twenty-one-stats.component.scss']
})
export class TwentyoneStatsComponent implements OnInit, OnDestroy {
  show: boolean;
  ...
  settings: Settings;
  @Input() componentRef: ComponentRef<TwentyoneStatsComponent>;
